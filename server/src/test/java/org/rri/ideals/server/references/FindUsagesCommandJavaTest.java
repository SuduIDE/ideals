...
public class FindUsagesCommandJavaTest extends ReferencesCommandTestBase {
  ...
  public void testFindUsagesJavaVariable() {
    ...
    final var answers = new HashSet<>(List.of(
            location(findUsagesJavaVariableUri, TestUtil.newRange(3, 8, 3, 9)),
            location(findUsagesJavaVariableUri, TestUtil.newRange(7, 8, 7, 14)),
            location(findUsagesJavaVariableUri, TestUtil.newRange(11, 15, 11, 16))));
  ...
  public void testFindUsagesJavaMethod() {
    ...
    final var answers = new HashSet<>(List.of(
            location(anotherUri, TestUtil.newRange(11, 8, 11, 26)),
            location(definitionUri, TestUtil.newRange(11, 8, 11, 11))));
  ...
  public void testFindUsagesJavaClass() {
    ...
    final var answers = new HashSet<>(List.of(
            location(definitionJavaUri, TestUtil.newRange(13, 8, 13, 19)),
            location(definitionJavaUri, TestUtil.newRange(13, 28, 13, 39)),
            location(typeDefinitionJavaUri, TestUtil.newRange(0, 7, 0, 18)),
            location(typeDefinitionJavaUri, TestUtil.newRange(4, 8, 4, 15)),
            location(typeDefinitionJavaUri, TestUtil.newRange(5, 8, 5, 19))));
